...
if __name__ == "__main__":
    cityscapes_root = 'D:/1Work/cnn/mrcnn/samples/cityscape'
    train_images = os.path.join(cityscapes_root, "/train_images")
    train_anns = os.path.join(cityscapes_root, "/train_image.json")
    val_images = os.path.join(cityscapes_root, "/val_images")
    val_anns = os.path.join(cityscapes_root, "val_image.json")
